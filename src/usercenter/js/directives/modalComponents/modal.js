      ...
      return `
        <div class="modalWrapper">
          ...
          <div class="modal" ng-if="${attrs.vm}.showModal">
            ...
            <button class="modal_close" type="button" ng-show="${attrs.vm}.isSubmitSuccess" ng-click="${attrs.vm}.hideModal()">×</button>
          ...
          <div class="modal_footer">
            <button type="button" class="modal_confirm"  ng-click="${attrs.vm}.hideModal()">确认</button>
          </div>
        </div>
      `;
    },
